...
consexp:
    plusexp {$1 }
  | plusexp CONS consexp { print "e -> e::e"; Data("Cons", Some (Tuple [$1 ; $3])) }
;
...
pattern:
    basepattern { $1 }
    | basepattern CONS pattern { DataPat("Cons", Some (TuplePat [$1; $3])) }
;
...
basepattern:
    ...
    | CONSTRUCTOR basepattern { DataPat($1, Some $2) }
